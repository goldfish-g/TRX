...
cp "$SHARED_EMC/tombpc.js" "$BUILD_DIR/tombpc.js"
cp "$SHARED_EMC/gameflow.js" "$BUILD_DIR/gameflow.js"
cp "$SHARED_EMC/ui.js" "$BUILD_DIR/ui.js"
cp "$SHARED_EMC/upload.js" "$BUILD_DIR/upload.js"
cp "$SHARED_EMC/viewport.js" "$BUILD_DIR/viewport.js"
cp "$SHARED_EMC/touch.js" "$BUILD_DIR/touch.js"
...
sed -i "s|src=\"tombpc.js\"|src=\"tombpc.js?${CACHE_BUST}\"|" "$BUILD_DIR/TRX.html"
sed -i "s|src=\"gameflow.js\"|src=\"gameflow.js?${CACHE_BUST}\"|" "$BUILD_DIR/TRX.html"
sed -i "s|src=\"ui.js\"|src=\"ui.js?${CACHE_BUST}\"|" "$BUILD_DIR/TRX.html"
sed -i "s|src=\"upload.js\"|src=\"upload.js?${CACHE_BUST}\"|" "$BUILD_DIR/TRX.html"
sed -i "s|src=\"viewport.js\"|src=\"viewport.js?${CACHE_BUST}\"|" "$BUILD_DIR/TRX.html"
sed -i "s|src=\"touch.js\"|src=\"touch.js?${CACHE_BUST}\"|" "$BUILD_DIR/TRX.html"
